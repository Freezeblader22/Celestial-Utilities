package com.freezeblader22.celestialutilities.screen;
...
public class ResearchTableScreen extends ContainerScreen<ResearchTableContainer> {
    private final ResourceLocation GUI = new ResourceLocation(CelestialUtilities.MOD_ID, "textures/gui/lightning_channeler_gui.png");
